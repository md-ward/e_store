...
import { faBatteryEmpty, faWarning } from '@fortawesome/free-solid-svg-icons';
import { Slide } from 'react-awesome-reveal';

const ViewContactusMessages = () => {
    ...
    return (
        <div className="p-6 w-full h-full overflow-y-auto">
            <Slide>          <h1 className="text-3xl font-bold mb-4 text-dark-blue" >Contact Us Messages</h1>
                <ul>
                    {
                        ...
                        messages.length == 0 ? <span className='flex justify-center items-center h-96  w-full uppercase gap-4 '>
                            ...
                            <FontAwesomeIcon icon={faWarning} className='text-6xl text-dark-blue' />
